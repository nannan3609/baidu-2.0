...
//天气
$('.realcontent').load("tab/myfa.html");
$('.tab li').each(function (index) {
    ...
    $(this).click(function () {
            ...
            if (index != 0) {
                ...
                $('.user').attr("src", "baiduimage/usertaba.png");
                $('.user').css({
                    'position': 'relative',
                    'top': '-2px'
                });
                ...
                $('.user').attr("src", "baiduimage/usertab.png");
            ...
            if (index == 0) {
                ...
                $('.realcontent').load("tab/nav.html");
            }
            else if (index == 2) {
                $('.realcontent').load("tab/news.html");
            }
            else if (index == 3) {
                $('.realcontent').load("tab/vedio.html");
            }
            else {
                $('.realcontent').load("tab/shop.html");
            }
            ;
        }
    );
...
function changeBack(value) {
    $("body").css({
        "background": "url(../baidu-2.0/baiduimage/" + value + ".jpg)",
    ...
    $(".so").css({
        ...
        "background-image": "url(../baidu-2.0/baiduimage/niu.png)",
...
//改变背景图片
function changBaidu() {
    $(".pic").attr("src", "baiduimage/pifubaidu.png");
}
//改变百度logo
...
if (storage.getItem("theme") == "normal" ||storage.getItem("theme") == null) {
        ...
        $(".pic").attr("src", "baiduimage/baidu.png");
        $(".pic").css({
            "width": "250px",
            "height": "75px",
            "margin-left": "-125px",
